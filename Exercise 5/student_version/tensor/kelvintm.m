...
elseif numel(in)==81
    ...
    out=[    in(1,1,1,1)     in(1,1,2,2)     in(1,1,3,3) sq2*in(1,1,1,2) sq2*in(1,1,2,3) sq2*in(1,1,1,3);
         ...
         sq2*in(1,2,1,1) sq2*in(1,2,2,2) sq2*in(1,2,3,3)   2*in(1,2,1,2)   2*in(1,2,2,3)   2*in(1,2,1,3);
         sq2*in(2,3,1,1) sq2*in(2,3,2,2) sq2*in(2,3,3,3)   2*in(2,3,1,2)   2*in(2,3,2,3)   2*in(2,3,1,3);
         sq2*in(1,3,1,1) sq2*in(1,3,2,2) sq2*in(1,3,3,3)   2*in(1,3,1,2)   2*in(1,3,2,3)   2*in(1,3,1,3)];
