...
xH        = matp(4);       % kinematic hardening modulus
xh        = matp(5);       % isotropic hardening modulus
...
alphan  =  sdvl(13);
%This will be passed to the problem so changing this would be appropriate
...
% Bbetatr = ..............trial value of the back-streye(3)ess tensor
Bbetatr = xH * Balpha;
